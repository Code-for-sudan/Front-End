...
const WelcomeNavigation = ({ onNext, onSkip }) => {
  return (
    <div className="absolute bottom-0 w-full flex justify-between items-center p-4 pt-12 overflow-hidden">
      <button
        onClick={onNext}
      ...
      <button className="text-sm font-bold text-gray-500 cursor-pointer" onClick={onSkip}>
        تخطي
      </button>
